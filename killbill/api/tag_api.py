...
class TagApi(object):
    ...
    def get_tag_audit_logs_with_history(self, tag_id=None, **kwargs):  # noqa: E501
    ...
    def get_tag_audit_logs_with_history_with_http_info(self, tag_id=None, **kwargs):  # noqa: E501
        """Retrieve tag audit logs with history by id  # noqa: E501
        ...
        if 'tag_id' in params and not re.search('\\w+-\\w+-\\w+-\\w+-\\w+', params['tag_id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `tag_id` when calling `get_tag_audit_logs_with_history`, must conform to the pattern `/\\w+-\\w+-\\w+-\\w+-\\w+/`")  # noqa: E501
        collection_formats = {}
    ...
    def search_tags(self, search_key=None, **kwargs):  # noqa: E501
    ...
    def search_tags_with_http_info(self, search_key=None, **kwargs):  # noqa: E501
        """Search tags  # noqa: E501
