...
class SubscriptionApi(object):
    ...
    def get_subscription_audit_logs_with_history(self, subscription_id=None, **kwargs):  # noqa: E501
    ...
    def get_subscription_audit_logs_with_history_with_http_info(self, subscription_id=None, **kwargs):  # noqa: E501
        """Retrieve subscription audit logs with history by id  # noqa: E501
        ...
        if 'subscription_id' in params and not re.search('\\w+-\\w+-\\w+-\\w+-\\w+', params['subscription_id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `subscription_id` when calling `get_subscription_audit_logs_with_history`, must conform to the pattern `/\\w+-\\w+-\\w+-\\w+-\\w+/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_subscription_by_key(self, external_key=None, **kwargs):  # noqa: E501
    ...
    def get_subscription_by_key_with_http_info(self, external_key=None, **kwargs):  # noqa: E501
        """Retrieve a subscription by external key  # noqa: E501
    ...
    def get_subscription_event_audit_logs_with_history(self, event_id=None, **kwargs):  # noqa: E501
    ...
    def get_subscription_event_audit_logs_with_history_with_http_info(self, event_id=None, **kwargs):  # noqa: E501
        """Retrieve subscription event audit logs with history by id  # noqa: E501
        ...
        if 'event_id' in params and not re.search('\\w+-\\w+-\\w+-\\w+-\\w+', params['event_id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `event_id` when calling `get_subscription_event_audit_logs_with_history`, must conform to the pattern `/\\w+-\\w+-\\w+-\\w+-\\w+/`")  # noqa: E501
        collection_formats = {}
    ...
    def update_subscription_quantity(self, subscription_id=None, body=None, created_by=None, **kwargs):  # noqa: E501
        """Update the quantity associated to a subscription  # noqa: E501
        ...
        :param Str created_by: (required)
        :param Date effective_from_date:
        :param Bool force_new_quantity_with_past_effective_date:
        :param Str reason:
        :param Str comment:
        :return: None
                 If the method is called asynchronously,
    ...
    def update_subscription_quantity_with_http_info(self, subscription_id=None, body=None, created_by=None, **kwargs):  # noqa: E501
        """Update the quantity associated to a subscription  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_subscription_quantity" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'subscription_id' is set
        if ('subscription_id' not in params or
                params['subscription_id'] is None):
            raise ValueError("Missing the required parameter `subscription_id` when calling `update_subscription_quantity`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_subscription_quantity`")  # noqa: E501
        # verify the required parameter 'created_by' is set
        if ('created_by' not in params or
                params['created_by'] is None):
            raise ValueError("Missing the required parameter `created_by` when calling `update_subscription_quantity`")  # noqa: E501

        if 'subscription_id' in params and not re.search('\\w+-\\w+-\\w+-\\w+-\\w+', params['subscription_id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `subscription_id` when calling `update_subscription_quantity`, must conform to the pattern `/\\w+-\\w+-\\w+-\\w+-\\w+/`")  # noqa: E501
        collection_formats = {}
        ...
        if 'effective_from_date' in params:
            query_params.append(('effectiveFromDate', params['effective_from_date']))  # noqa: E501
        if 'force_new_quantity_with_past_effective_date' in params:
            query_params.append(('forceNewQuantityWithPastEffectiveDate', params['force_new_quantity_with_past_effective_date']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/1.0/kb/subscriptions/{subscriptionId}/quantity', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
